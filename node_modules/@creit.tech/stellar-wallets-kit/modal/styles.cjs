...
const modalDialogStyles = lit.css`
  .dialog-modal {
    position: fixed;
    z-index: 99;
...
`;
const modalDialogBodyStyles = lit.css`
  .dialog-modal-body {
    display: flex;
...
`;
const modalHelpSection = lit.css`
  .help-container {
    width: 100%;
  }
...
`;
const modalWalletsSection = lit.css`
  .wallets-container {
    width: 100%;
    height: 100%;
...
exports.modalAnimations = modalAnimations;
exports.modalDialogBodyStyles = modalDialogBodyStyles;
exports.modalDialogStyles = modalDialogStyles;
exports.modalHelpSection = modalHelpSection;
exports.modalWalletsSection = modalWalletsSection;
