...
`;
const modalDialogBodyStyles = css`
  .dialog-modal-body {
    display: flex;
...
export { backdropStyles, modalAnimations, modalDialogBodyStyles, modalDialogStyles, modalHelpSection, modalWalletsSection };
